...
(
  ...
  E'As a Cabin Crew Member at Jet2 Roblox Ye, you will be responsible for ensuring the safety and comfort of all passengers during flights. Your duties include conducting pre-flight safety checks, delivering safety demonstrations, serving food and beverages, and handling any in-flight emergencies.\n\nNo prior experience is required — we provide comprehensive training to all new crew members. You will learn emergency procedures, customer service excellence, and cabin management skills.\n\nThis is a great entry-level position for anyone passionate about aviation in the Roblox community.',
  'Volunteer',
  'In-game (Roblox)',
...
(
  ...
  E'As a Ground Operations Agent, you will play a critical role in ensuring smooth airport operations at Jet2 Roblox Ye. Your responsibilities include coordinating aircraft parking, managing pushback procedures, directing ground traffic, and communicating with flight crew.\n\nYou will work closely with pilots and other ground staff to maintain on-time performance. This role requires attention to detail and the ability to work efficiently under time pressure.\n\nTraining is provided for all procedures.',
  'Volunteer',
  'In-game (Roblox)',
  NULL,
  now(),
