  ...
  <main class="page">
    <div class="container legal-content">
      ...
      <section class="prose">
        ...
        E-Mail: sowasvonphilipp23@gmail.com</p>
        ...
        <h2>4. Empfänger von personenbezogenen Daten</h2>
        ...
        <p>Wenn die Datenverarbeitung auf Grund von Art. 6 Abs. 1 lit. e oder f DSGVO erfolgt, haben Sie jederzeit das Recht, aus Gründen, die sich aus Ihrer besonderen Situation ergeben, gegen die Verarbeitung Ihrer personenbezogenen Daten Widerspruch einzulegen; dies gilt auch für ein auf diese Bestimmungen gestütztes Profiling. Die jeweilige Rechtsgrundlage, auf denenen eine Verarbeitung beruht, entnehmen Sie dieser Datenschutzerklärung. Wenn Sie Widerspruch einlegen, werden wir Ihre betroffenen personenbezogenen Daten nicht mehr verarbeiten, es sei denn, wir können zwingende schutzwürdige Gründe für die Verarbeitung nachweisen, die Ihre Interessen, Rechte und Freiheiten überwiegen oder die Verarbeitung dient der Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen (Widerspruch nach Art. 21 Abs. 1 DSGVO).</p>
        ...
        <h2>5. Auskunft, Berichtigung und Löschung</h2>
...
<script setup>
useSeoMeta({
  title: 'Datenschutz — Sunshine Studio',
  description: 'Datenschutzerklärung für Sunshine Studio.'
})
</script>

<style scoped>
.page { min-height: 100vh; padding: 64px 0; }
.container { max-width: 800px; margin: 0 auto; padding: 0 24px; }
.page-title { font-size: 2.5rem; font-weight: 900; color: var(--text); margin-bottom: 8px; letter-spacing: -0.02em; }
.last-updated { color: var(--muted); font-size: 0.9rem; margin-bottom: 40px; }
