<template>
  <main class="login-page">
    ...
    <div class="login-card">
      ...
      <p class="login-note">
        By continuing, you agree to our <NuxtLink to="/tos">Terms</NuxtLink> and <NuxtLink to="/datenschutz">Privacy Policy</NuxtLink>.<br>
        We only access your Discord username and ID.
      </p>
    </div>
  </main>
</template>
...
.discord-btn:disabled { opacity: 0.6; cursor: wait; transform: none; box-shadow: none; }
...
.login-note a { color: var(--red); text-decoration: none; font-weight: 600; }
